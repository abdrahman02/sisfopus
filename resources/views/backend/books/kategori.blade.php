...
<a href="#" class="btn btn-md bg-success me-3 link-light float-end" data-bs-toggle="modal" data-bs-target="#tbhKategori"
    aria-pressed="true">
    ...
    <div class="col-lg-12 mb-lg-0 mb-4">
        <div class="card shadow">
            <div class="card-header pb-0 pt-3 bg-transparent">
                <h6 class="text-capitalize">Tabel Kategori Buku</h6>
            </div>
                    ...
                    <table class="table align-items-center mb-0 text-center">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <span class="text-secondary text-xs font-weight-bold">Majalah & Buku Dongeng</span>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="text-secondary text-xs font-weight-bold">Buku Pelajaran Komputer</span>
                                </td>
                                <td class="align-middle text-center text-lg">
                                    <a href="#" class="badge badge-lg bg-gradient-warning me-3 link-light">
                                        <i class="fa-regular fa-pen-to-square"></i>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="text-secondary text-xs font-weight-bold">Buku Pelajaran IPA</span>
                                </td>
                                <td class="align-middle text-center text-lg">
                                    <a href="#" class="badge badge-lg bg-gradient-warning me-3 link-light">
                                        <i class="fa-regular fa-pen-to-square"></i>
...
{{-- Tambah Data --}}
<div class="modal fade" id="tbhKategori" tabindex="-1" role="dialog" aria-labelledby="modal-form" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-md" role="document">
        <div class="modal-content">
            <div class="modal-body p-0">
                <div class="card card-plain">
                    <div class="card-header pb-0 text-left">
                        <h4 class="font-weight-bolder text-info text-gradient">Form penambahan kategori</h4>
                    </div>
                    <div class="card-body">
                        <form role="form text-left">
                            ...
                            <div class="input-group mb-3">
                                <input type="text" class="form-control" placeholder="Masukkan nama kategori..."
                                    aria-label="kategori" required autofocus>
                            </div>
                            <div class="text-end">
...
{{-- Ubah Data --}}
<div class="modal fade" id="ubhKategori" tabindex="-1" role="dialog" aria-labelledby="modal-form" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-md" role="document">
        <div class="modal-content">
            <div class="modal-body p-0">
                <div class="card card-plain">
